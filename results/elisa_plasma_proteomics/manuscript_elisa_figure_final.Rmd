...
ggpaired(data = pdata, id = "Number.x", x = "Manifestation", y = "log2_conc", fill = "Manifestation", palette = colfunc(length(unique(pdata$`ttr_group`))), line.color = "ttr_group", line.size = 0.4) +
  ...
  guides(fill=guide_legend(title="GBM\nOccurence", ncol=1),
         col=guide_legend(title="Time to Recurrence")) -> p1
